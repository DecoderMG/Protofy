 ...
 * Handles setting the EditText left padding from dialog preference
 */
public class EditTextLeftPaddingPreference extends DialogPreference {

    private TextView prefTextView, prefSliderTextView;
    private Slider prefSlider;
    private EditTextPreferences editTextPrefs;

    public EditTextLeftPaddingPreference(Context oContext, AttributeSet attrs) {
    ...
    public void onBindDialogView(View view) {
        ...
        prefTextView.setText("Changing this will change the default starting value of every EditTexts left padding value. Which is measured in DP units");
        prefSliderTextView = (TextView) view.findViewById(R.id.prefSliderTextView);
        prefSliderTextView.setText(editTextPrefs.getDefaultEditTextLeftPadding() + "dp");

        prefSlider = (Slider) view.findViewById(R.id.prefSlider);
        prefSlider.setMax(editTextPrefs.getMaxEditTextLeftPadding());
        prefSlider.setValue(editTextPrefs.getDefaultEditTextLeftPadding());
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            editTextPrefs.setDefaultEditTextLeftPadding(prefSlider.getValue() + "");
        }
    }
}
