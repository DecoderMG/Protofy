 ...
 * Handles setting the TextView top padding from dialog preference
 */
public class TextViewTopPaddingPreference extends DialogPreference {

    private TextView prefTextView, prefSliderTextView;
    private Slider prefSlider;
    private TextViewPreferences textViewPrefs;

    public TextViewTopPaddingPreference(Context oContext, AttributeSet attrs) {
    ...
    public void onBindDialogView(View view) {
        ...
        prefTextView.setText("Changing this will change the default starting value of every TextViews top padding value. Which is measured in DP units");
        prefSliderTextView = (TextView) view.findViewById(R.id.prefSliderTextView);
        prefSliderTextView.setText(textViewPrefs.getDefaultTextViewTopPadding() + "dp");

        prefSlider = (Slider) view.findViewById(R.id.prefSlider);
        prefSlider.setMax(textViewPrefs.getMaxTextViewTopPadding());
        prefSlider.setValue(textViewPrefs.getDefaultTextViewTopPadding());
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            textViewPrefs.setDefaultTextViewTopPadding(prefSlider.getValue() + "");
        }
    }
}
