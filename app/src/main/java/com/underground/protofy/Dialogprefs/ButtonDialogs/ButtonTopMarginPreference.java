 ...
 * Handles setting the Button top margins from dialog preference
 */
public class ButtonTopMarginPreference extends DialogPreference {

    private TextView prefTextView, prefSliderTextView;
    private Slider prefSlider;
    private ButtonPreferences textViewPrefs;

    public ButtonTopMarginPreference(Context oContext, AttributeSet attrs) {
