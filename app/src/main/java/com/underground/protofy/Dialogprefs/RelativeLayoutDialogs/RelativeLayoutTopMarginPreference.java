 ...
 * Handles setting the Relative Layout top margins from dialog preference
 */
public class RelativeLayoutTopMarginPreference extends DialogPreference {

    private TextView prefTextView, prefSliderTextView;
    private Slider prefSlider;
    private RelativeLayoutPreferences textViewPrefs;

    public RelativeLayoutTopMarginPreference(Context oContext, AttributeSet attrs) {
    ...
    public void onBindDialogView(View view) {
        ...
        prefTextView.setText("Changing this will change the default starting value of every RelativeLayouts top margin value. Which is measured in DP units");
        prefSliderTextView = (TextView) view.findViewById(R.id.prefSliderTextView);
        prefSliderTextView.setText(textViewPrefs.getDefaultRelativeLayoutTopMargin() + "dp");

        prefSlider = (Slider) view.findViewById(R.id.prefSlider);
        prefSlider.setMax(textViewPrefs.getMaxRelativeLayoutTopMargin());
        prefSlider.setValue(textViewPrefs.getDefaultRelativeLayoutTopMargin());
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            textViewPrefs.setDefaultRelativeLayoutTopMargin(prefSlider.getValue() + "");
        }
    }
}
