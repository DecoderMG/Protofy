 ...
 * Handles setting the Button text size from dialog preference
 */
public class ButtonTextSizePreference extends DialogPreference {

    private TextView prefTextView, prefSliderTextView;
    private Slider prefSlider;
    private ButtonPreferences textViewPrefs;

    public ButtonTextSizePreference(Context oContext, AttributeSet attrs) {
    ...
    public void onBindDialogView(View view) {
        ...
        prefTextView.setText("Changing this value will change the default starting value of every Buttons text size. Which is measured in SP units");
        prefSliderTextView = (TextView) view.findViewById(R.id.prefSliderTextView);
        prefSliderTextView.setText(textViewPrefs.getDefaultButtonTextSize() + "dp");

        prefSlider = (Slider) view.findViewById(R.id.prefSlider);
        prefSlider.setMax(textViewPrefs.getMaxButtonTextSize());
        prefSlider.setValue(textViewPrefs.getDefaultButtonTextSize());
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            textViewPrefs.setDefaultButtonTextSize(prefSlider.getValue() + "");
        }
    }
}
