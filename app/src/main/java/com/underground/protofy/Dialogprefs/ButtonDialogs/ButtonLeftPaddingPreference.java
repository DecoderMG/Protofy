 ...
 * Handles setting the Button left padding from dialog preference
 */
public class ButtonLeftPaddingPreference extends DialogPreference {

    private TextView prefTextView, prefSliderTextView;
    private Slider prefSlider;
    private ButtonPreferences textViewPrefs;

    public ButtonLeftPaddingPreference(Context oContext, AttributeSet attrs) {
    ...
    public void onBindDialogView(View view) {
        ...
        prefTextView.setText("Changing this will change the default starting value of every Buttons left padding value. Which is measured in DP units");
        prefSliderTextView = (TextView) view.findViewById(R.id.prefSliderTextView);
        prefSliderTextView.setText(textViewPrefs.getDefaultButtonLeftPadding() + "dp");

        prefSlider = (Slider) view.findViewById(R.id.prefSlider);
        prefSlider.setMax(textViewPrefs.getMaxButtonLeftPadding());
        prefSlider.setValue(textViewPrefs.getDefaultButtonLeftPadding());
    ...
    public void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            textViewPrefs.setDefaultButtonLeftPadding(prefSlider.getValue() + "");
        }
    }
}
