...
/**
 * Custom TextView class to build upon Android's existing TextView class.
 */
public class mTextView extends TextView {
    ...
    private String textHexColor, backgroundHexColor, tintHexColor, visibility;
    ...
    private int alpha, textAlpha, leftPadding, rightPadding, topPadding, bottomPadding,
            ...
            marginLeft, marginRight, marginTop, marginBottom, tintColor, oldTintColor;
    ...
    /**
     * Initialize the custom TextView. Always call in constructor.
     */
    private void initializeView() {
        ...
        textViewPrefs = new TextViewPreferences(mContext);
        visibility = "visible";

        Text = textViewPrefs.getDefaultTextViewText();

        if (textViewPrefs.getTextViewLayoutWrappingWidth().equals("0")) {
            widthWrappingParam = RelativeLayout.LayoutParams.WRAP_CONTENT;
        } else {
            widthWrappingParam = RelativeLayout.LayoutParams.MATCH_PARENT;
        }
        if (textViewPrefs.getTextViewLayoutWrappingHeight().equals("0")) {
        ...
        textSize = textViewPrefs.getDefaultTextViewTextSize();
        viewScaleX = getScaleX();
        viewScaleY = getScaleY();

        textHexColor = String.format("%08x", textViewPrefs.getTextViewTextColor());
        textColor = textViewPrefs.getTextViewTextColor();
        backgroundHexColor = String.format("%08x", textViewPrefs.getTextViewBackgroundColor());
        backgroundColor = textViewPrefs.getTextViewBackgroundColor();

        if (textViewPrefs.getDefaultTextViewFont().equals("0")) {
            textTypeface = Typeface.DEFAULT;
        } else if (textViewPrefs.getDefaultTextViewFont().equals("1")) {
            textTypeface = Typeface.MONOSPACE;
        } else if (textViewPrefs.getDefaultTextViewFont().equals("2")) {
            textTypeface = Typeface.SERIF;
        } else if (textViewPrefs.getDefaultTextViewFont().equals("3")) {
            textTypeface = Typeface.SANS_SERIF;
        }
        if (textViewPrefs.getDefaultTextViewEmphasis().equals("0")) {
            typefaceStyle = Typeface.NORMAL;
        } else if (textViewPrefs.getDefaultTextViewEmphasis().equals("1")) {
            typefaceStyle = Typeface.BOLD;
        } else if (textViewPrefs.getDefaultTextViewEmphasis().equals("2")) {
            typefaceStyle = Typeface.ITALIC;
        } else if (textViewPrefs.getDefaultTextViewEmphasis().equals("3")) {
        ...
        leftPadding = textViewPrefs.getDefaultTextViewLeftPadding();
        rightPadding = textViewPrefs.getDefaultTextViewRightPadding();
        topPadding = textViewPrefs.getDefaultTextViewTopPadding();
        bottomPadding = textViewPrefs.getDefaultTextViewBottomPadding();

        marginLeft = textViewPrefs.getDefaultTextViewLeftMargin();
        marginRight = textViewPrefs.getDefaultTextViewRightMargin();
        marginBottom = textViewPrefs.getDefaultTextViewBottomMargin();
        marginTop = textViewPrefs.getDefaultTextViewTopMargin();

        lineSpacingAdd = textViewPrefs.getDefaultTextViewLineSpacing();
    ...
    /**
     * Associate Parent views ID that this TextView belongs to the TextView.
    ...
    /**
     * Set TextView ID so that we can refer to button by ID
    ...
    public void setLayoutWrapping(int widthParam, int heightParam) {
        widthWrappingParam = widthParam;
        heightWrappingParam = heightParam;
        RelativeLayout.LayoutParams tempParams = new RelativeLayout.LayoutParams(widthWrappingParam, heightWrappingParam);
    ...
    public int getViewTextAlpha() {
        return textAlpha;
    }

    public void setViewTextAlpha(int textAlphaInput) {
        textAlpha = textAlphaInput;
    }
    ...
    /**
     * Set string ID to TextView for a user friendly ID.
    ...
    /**
     * Get the IDs of all views linked to this TextView
    ...
    /**
     * Get all string IDs of all views linked to this TextView
    ...
    /**
     * Get all parent layout parameters assigned to the TextView
    ...
    /**
     * Get last layout parameter linked to the TextView.
     * @return last layout param applied to the TextView
     */
    public int getLastLayoutParam() {
        return linkedViewLayoutParams.getLast();
    }

    /**
     * Get ID of the lat linked view to the TextView
    ...
    *			linkedViewId = Either a -1 (Parent Layout selected) or view Id which will be checked
    ...
    /**
     * Add starting Parent layout parameters to TextView
    ...
    public boolean isrightMarginDefaultModified(){
        return textViewPrefs.getDefaultTextViewRightMargin() != 16;
    }
    public boolean isleftMarginDefaultModified(){
        return textViewPrefs.getDefaultTextViewLeftMargin() != 16;
    }
    public boolean istopMarginDefaultModified(){
        return textViewPrefs.getDefaultTextViewTopMargin() != 16;
    }
    public boolean isbottomMarginDefaultModified(){
        return textViewPrefs.getDefaultTextViewBottomMargin() != 16;
    }
    public boolean isrightPaddingDefaultModified(){
        return textViewPrefs.getDefaultTextViewRightPadding() != 24;
    }
    public boolean isleftPaddingDefaultModified(){
        return textViewPrefs.getDefaultTextViewLeftPadding() != 24;
    }
    public boolean istopPaddingDefaultModified(){
        return textViewPrefs.getDefaultTextViewTopPadding() != 16;
    }
    public boolean isbottomPaddingDefaultModified(){
        return textViewPrefs.getDefaultTextViewBottomPadding() != 16;
    }
    public boolean isTextFontDefaultModified(){
        return textViewPrefs.getDefaultTextViewFont() != "0";
    }
    public boolean isTextEmphasisDefaultModified(){
        return textViewPrefs.getDefaultTextViewEmphasis() != "0";
    }
    public boolean isTextLineSpacingDefaultModified(){
        return textViewPrefs.getDefaultTextViewLineSpacing() != 10;
    }
    ...
    public void redrawView() {
        ...
        if(this.getViewVisibility().equals("visible")) {
            ...
            this.setText("invisible textview");
            this.setBackgroundColor(Color.parseColor("#33ffffff"));
            this.setTextColor(Color.parseColor("#33000000"));
        }
        if(isViewSizeEdited) {
        ...
        this.setViewTextAlpha(textAlpha);
    }
     ...
     */
    public void initCopyView(mTextView view, String option) {
        ...
        if (option.equals("set Text")) {
            ...
            this.setViewVisibility(this.getViewVisibility());
        ...
        //Copy over all variables for any preview view
            ...
            this.setBackgroundColor(view.getViewColor("background"));
            this.setTextColor(view.getViewColor("text"));
            this.setViewTintColor(view.getViewTintColor(), view.getTintHexValue());
            this.setViewPadding(view.getViewPadding("left"), view.getViewPadding("right"), view.getViewPadding("top"), view.getViewPadding("bottom"));
