...
public abstract class BorderMenuActivity extends FragmentActivity {
    ...
    RelativeLayout mToolTipLayout;
    RelativeLayout menuButtonLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuButtonLayout = (RelativeLayout) findViewById(R.id.btn_menu);
    ...
    public void setToolTipRemoval(RelativeLayout layout) {
        mToolTipLayout = layout;
    }

    public RelativeLayout getBtnMenu() {
    ...
    public void showMenu() {
        ...
        ObjectAnimator.ofFloat(viewFade, "alpha", 0.2f)
                .setDuration(ANIMATIONDURATION).start();
        menuShowed = true;
        float originalWidth = contentView.getWidth();
        float width = contentView.getWidth() - Utils.dpToPx(64, getResources());
    ...
    public void hideMenu() {
        // Animate icon button
        final float centerRotateAnimation = Utils.dpToPx(64, getResources()) / 2;
        ...
        menuShowed = false;
        mToolTipLayout.removeAllViews();


    }

    public void hideMenuKeepToolTip() {
        // Animate icon button
        final float centerRotateAnimation = Utils.dpToPx(56, getResources()) / 2;
        RotateAnimation rotateAnimationCenter = new RotateAnimation(225, 0, centerRotateAnimation, centerRotateAnimation);
        rotateAnimationCenter.setInterpolator(new AccelerateInterpolator());
