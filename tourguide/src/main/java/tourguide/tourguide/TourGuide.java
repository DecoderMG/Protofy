...
//        TODO: throw exception if either mActivity, mDuration, mHighlightedView is null
    ...
    private void setupToolTip(FrameLayoutWithHole frameLayoutWithHole) {
        ...
        if (mToolTip != null) {
            ...
            mToolTipViewGroup = layoutInflater.inflate(R.layout.tooltiplayout, null);
            ...
            mToolTipViewGroup.measure(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
...
//            ((ViewGroup) mActivity.getWindow().getDecorView().findViewById(android.R.id.content)).addView(mToolTipViewGroup, layoutParams);
            frameLayoutWithHole.addView(mToolTipViewGroup, layoutParams);
    ...
    public FrameLayoutWithHole getFrameLayoutWithHole() {
...
//            display.getSize(size);
     ...
     * @return return AnimateTutorial instance for chaining purpose
     */
    public TourGuide setToolTip(ToolTipIt toolTip) {
        mToolTip = toolTip;
        return this;
    }
